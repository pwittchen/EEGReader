...
public class MenuInflater {
     ...
     * @param menu The Menu to inflate into. The item and submenus will be
     *            added to this Menu.
     */
    ...
    private class MenuState {
        ...
        /*
         * Group state is set on item as they are added, allowing an item to
         * override its group state. (As opposed to set on item at the group end tag.)
         */
        private int groupId;
