...
public interface MenuItem {
     ...
     * Use sparingly! If too many item are set to always show in the Action Bar it can
     * crowd the Action Bar and degrade the user experience on devices with smaller screens.
     * A good rule of thumb is to have no more than 2 item set to always show at a time.
     */
     ...
     * item will be shown before all item (within its category) that have
     ...
     * shortcut characters will be displayed in lower case. Note that menu item
     ...
     * mutually-exclusive item (set via {@link Menu#setGroupCheckable(int, boolean, boolean)},
     * the other item in the group will be unchecked.
     * <p>
     * See {@link Menu} for the menu types that support check marks.
     *
     * @see #setCheckable
