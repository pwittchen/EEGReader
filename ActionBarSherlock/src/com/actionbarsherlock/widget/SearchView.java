...
public class SearchView extends LinearLayout implements CollapsibleActionView {
    ...
    */
     ...
     * or if it should depend on the flags set in the individual item retrieved from the
     ...
     *
     * @param enable true if all item should have a query refinement button, false if only
     * those item that have a query refinement flag set should have the button.
     *
    ...
    /**
     * Returns whether query refinement is enabled for all item or only specific ones.
     * @return true if enabled for all item, false otherwise.
     */
