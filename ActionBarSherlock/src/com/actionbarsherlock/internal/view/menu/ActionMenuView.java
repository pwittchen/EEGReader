...
public class ActionMenuView extends IcsLinearLayout implements MenuBuilder.ItemInvoker, MenuView {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // Special formatting can change whether item can fit as action buttons.
    ...
    private void onMeasureExactFormat(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        // This is used as a bitfield to locate the smallest item present. Assumes childCount < 64.
        ...
        // Divide space for remaining cells if we have item that can expand.
        // Try distributing whole leftover cells to smaller item first.
        ...
        while (expandableItemCount > 0 && cellsRemaining > 0) {
            ...
            for (int i = 0; i < childCount; i++) {
                ...
                // Don't try to expand item that shouldn't.
            ...
            // Items that get expanded will always be in the set of smallest item when we're done.
            smallestItemsAt |= minCellsAt;

            if (minCellsItemCount > cellsRemaining) break; // Couldn't expand anything evenly. Stop.

            // We have enough cells, all minimum size item will be incremented.
            minCells++;
        ...
        // evenly among the smallest item
        ...
        if (cellsRemaining > 0 && smallestItemsAt != 0 &&
            ...
            if (!singleItem) {
                // The item at the far edges may only expand by half in order to pin to either side.
        ...
        // Remeasure any item that have had extra space allocated to them.
        if (needsExpansion) {
