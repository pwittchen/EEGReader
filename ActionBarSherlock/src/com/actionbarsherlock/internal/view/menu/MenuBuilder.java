...
public class MenuBuilder implements Menu {
    ...
    /** Contains all of the item for this menu */
    private ArrayList<MenuItemImpl> mItems;

    /** Contains only the item that are currently visible.  This will be created/refreshed from
     * {@link #getVisibleItems()} */
    private ArrayList<MenuItemImpl> mVisibleItems;
    /**
     * Whether or not the item (or any one item's shown state) has changed since it was last
     * fetched from {@link #getVisibleItems()}
     */
    private boolean mIsVisibleItemsStale;

    /**
     * Contains only the item that should appear in the Action Bar, if present.
     */
    private ArrayList<MenuItemImpl> mActionItems;
    /**
     * Contains item that should NOT appear in the Action Bar, if present.
     */
    private ArrayList<MenuItemImpl> mNonActionItems;

    /**
     * Whether or not the item (or any one item's action state) has changed since it was
     * last fetched.
     */
    private boolean mIsActionItemsStale;

    /**
     * Default value for how added item should show in the action list.
     */
     ...
     * should be set on all item added to this menu.
     */
    ...
    /**
     * Called by menu item to execute their associated action
     */
    ...
    public void setGroupVisible(int group, boolean visible) {
        ...
        // We handle the notification of item being changed ourselves, so we use setVisibleInt rather
        // than setVisible and at the end notify of item being changed
    ...
    /**
     * Returns the ordering across all item. This will grab the category from
     ...
     *         all the item (even from other categories).
     */
    ...
    /*
     * This function will return all the menu and sub-menu item that can
    ...
    MenuItemImpl findItemWithShortcutForKey(int keyCode, KeyEvent event) {
        // Get all item that can be associated directly or indirectly with the keyCode
    ...
    /**
     * This method determines which menu item get to be 'action item' that will appear
     * in an action bar and which item should be 'overflow item' in a secondary menu.
     ...
     * limit the conceptual complexity of the item presented within an action bar. Only a few
     ...
     * item may be added. If an item that is part of a group cannot fit within the remaining
     ...
     *
     * <p>The space freed by demoting a full group cannot be consumed by future menu item.
     * Once item begin to overflow, all future item become overflow item as well. This is
    ...
    public void flagActionItems() {
        ...
        // Presenters flag action item as needed.
    ...
    /**
     * Sets the current menu info that is set on all item added to this menu
