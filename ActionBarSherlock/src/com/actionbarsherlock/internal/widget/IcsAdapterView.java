...
public abstract class IcsAdapterView<T extends Adapter> extends ViewGroup {
    ...
    /**
     * View to show if there are no item to show.
     */
    private View mEmptyView;

    /**
     * The number of item in the current adapter.
     */
    @ViewDebug.ExportedProperty(category = "list")
    int mItemCount;

    /**
     * The number of item in the adapter before a data changed event occurred.
     */
    int mOldItemCount;

    /**
     * Represents an invalid position. All valid positions are in the range 0 to 1 less than the
     * number of item in the current adapter.
     */
    ...
    /**
     * @return The number of item owned by the Adapter associated with this
     *         AdapterView. (This is the number of data item, which may be
